...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioFormaVenta, RepositorioFormaVenta>();
            ...
            service.AddScoped<IserviciosFormaVenta, ServcioFormaVenta>();
            ...
            {
                var repositorio = new RepositorioFormaVenta();
                return new ServcioFormaVenta(repositorio, cadena);
            });
